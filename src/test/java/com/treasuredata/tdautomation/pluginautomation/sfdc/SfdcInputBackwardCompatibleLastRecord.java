...
public class SfdcInputBackwardCompatibleLastRecord extends InputPluginBackwardCompatible {
    public static String NAME = "lastRecord";
    ...
    public SfdcInputBackwardCompatibleLastRecord(){
        ...
        LOGGER = LogManager.getLogger(SfdcInputBackwardCompatibleLastRecord.class.getName());
    }
}
