...
/** Google Drive TC 3.20:cVerify Incremental Loading when a file cloned first and then moved from one folder to another folder **/
@Listeners(TestCaseBase.class)

public class GoogleDriveClonedFileFolderIncremental extends GoogleDriveIncreamentalFolder{
     ...
     */
    public GoogleDriveClonedFileFolderIncremental(){
    ...
    public void firstExportDataToGoogleDrive() throws IOException {
        folderId1 = googleDriveApi.createFolder("Cloned_Folder1");
    ...
    public void uploadAnotherFileInGdFolder() throws IOException{
        ...
        folderId2 = googleDriveApi.createFolder("Cloned_Folder2");
     ...
     * Clone the file 2 from folder2 and move it to folder1 using api
    ...
    public void secondCallDataTransferToTdV2(){
        try {
            fileId4 = googleDriveApi.cloneFile(fileId2, "copy_file.csv");
            googleDriveApi.moveFileBetweenFolders(fileId4, folderId1);
            Thread.sleep(60000);
